...
func (*InfoRequest) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{0} }
...
func (*InfoResponse) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{1} }
...
func (*ReloadRequest) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{2} }
...
func (*BackendRequest) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{3} }

type Upstream struct {
	Address string                     `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
	Latency *google_protobuf2.Duration `protobuf:"bytes,2,opt,name=latency" json:"latency,omitempty"`
...
func (*Upstream) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{4} }
...
func (m *Upstream) GetLatency() *google_protobuf2.Duration {
	if m != nil {
		return m.Latency
	}
	return nil
...
func (*Backend) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{5} }
...
func (*BackendResponse) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{6} }
...
type ProxyClient interface {
	...
	Reload(ctx context.Context, in *ReloadRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
...
func (c *proxyClient) Info(ctx context.Context, in *InfoRequest, opts ...grpc.CallOption) (*InfoResponse, error) {
	...
	err := grpc.Invoke(ctx, "/stellar.services.proxy.v1.Proxy/Info", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *proxyClient) Reload(ctx context.Context, in *ReloadRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
...
type ProxyServer interface {
	...
	Reload(context.Context, *ReloadRequest) (*google_protobuf1.Empty, error)
