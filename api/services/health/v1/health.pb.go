...
func (*HealthResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_health_0a7e7016abc8c6ea, []int{0}
}
...
func (m *HealthResponse) GetStartedAt() *types.Timestamp {
	if m != nil {
		return m.StartedAt
	}
	return nil
...
func (*Peer) Descriptor() ([]byte, []int) {
	return fileDescriptor_health_0a7e7016abc8c6ea, []int{1}
}
...
func init() {
	proto.RegisterFile("github.com/ehazlett/stellar/api/services/health/v1/health.proto", fileDescriptor_health_0a7e7016abc8c6ea)
}

var fileDescriptor_health_0a7e7016abc8c6ea = []byte{
