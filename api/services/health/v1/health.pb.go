...
func (*InfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_19892855f2b86fb7, []int{0}
}
...
func (*InfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_19892855f2b86fb7, []int{1}
}
...
type NodeHealth struct {
	...
	Peers                []*Peer          `protobuf:"bytes,8,rep,name=peers,proto3" json:"peers,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (*NodeHealth) Descriptor() ([]byte, []int) {
	return fileDescriptor_19892855f2b86fb7, []int{2}
}
...
func (*HealthResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_19892855f2b86fb7, []int{3}
}
...
func (*Peer) Descriptor() ([]byte, []int) {
	return fileDescriptor_19892855f2b86fb7, []int{4}
}
...
func init() {
	proto.RegisterFile("github.com/ehazlett/stellar/api/services/health/v1/health.proto", fileDescriptor_19892855f2b86fb7)
}

var fileDescriptor_19892855f2b86fb7 = []byte{
