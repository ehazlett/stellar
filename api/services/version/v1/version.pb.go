...
It is generated from these files:
	github.com/ehazlett/stellar/api/services/version/v1/version.proto
...
func (c *versionClient) Version(ctx context.Context, in *google_protobuf.Empty, opts ...grpc.CallOption) (*VersionResponse, error) {
	...
	err := grpc.Invoke(ctx, "/stellar.services.version.v1.Version/Version", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() {
	proto.RegisterFile("github.com/ehazlett/stellar/api/services/version/v1/version.proto", fileDescriptorVersion)
}
